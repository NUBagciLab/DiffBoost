#######
# Here we use the default augmentation from nnUNet
# One relative strong augmentation baseline
######
...
def nnunet_augmentation(patch_size, augment_key='2D'):
    if augment_key == '2D':
...
def spatial_aug(patch_size, augment_key='2D'):
    if augment_key == '2D':
        params = default_2D_augmentation_params
    else:
        params = default_3D_augmentation_params
