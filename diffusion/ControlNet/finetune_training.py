...
def train(pretrained_path, prompts_path, out_dir, epochs=10):
    ...
    # Misc
    dataset = MyDataset(dataset_file=prompts_path)
...
def get_config():
    ...
    parser.add_argument('--prompts_path', type=str, default='/data/datasets/DiffusionMedAug/meniscus/images/prompts.json',
...
if __name__ == '__main__':
    args = get_config()
    train(args.pretrained_dir, args.prompts_path, args.out_dir, args.epochs)
